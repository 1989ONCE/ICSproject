                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <form method="POST" action="{{ route('profile.change') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="flex items-center justify-end px-6 py-3 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                        <a href="{{route('profile.remove')}}">
                                            <button data-modal-hide="defaultModal" type="button" class="text-white bg-rose-600 hover:bg-rose-500 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">移除頭像</button>
                                        </a>    
